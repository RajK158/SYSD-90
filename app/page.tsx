...
export default function LandingPage() {
  return (
    <div className="min-h-screen w-full bg-[#0C0C0C] text-[#9A9494] font-sans selection:bg-[#E8A83830] selection:text-[#E8A838] dot-grid">
      ...
      <nav className="sticky top-0 z-50 w-full border-b border-[#1F1F1F] bg-[#0C0C0C]/80 backdrop-blur-xl">
        ...
        >
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <span className="font-semibold text-[#F0EDED] tracking-tight" style={{ fontSize: '15px', letterSpacing: '-0.01em' }}>Sysd 90</span>
          </Link>
      ...
      {/* ═══ Hero Section ═══ */}
      <section className="w-full" style={{ minHeight: '85vh' }}>
        <Wide className="flex flex-col items-center justify-center text-center py-20 lg:py-28">
          <span
          ...
          <h1
            className="animate-fade-up-1 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-semibold text-[#F0EDED] tracking-tight leading-[1.08]"
            style={{ marginBottom: '36px', maxWidth: '900px' }}
          >
          ...
          <p
            className="animate-fade-up-2 text-lg md:text-xl text-[#9A9494] leading-relaxed"
          ...
          <div className="animate-fade-up-3 flex flex-col sm:flex-row items-center" style={{ gap: '16px' }}>
            <Link
              href="/signup"
      ...
      <footer className="w-full border-t border-[#1F1F1F]" style={{ paddingTop: '40px', paddingBottom: '40px', marginTop: '32px' }}>
        <Wide className="flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
          <span className="text-xs font-mono text-[#5C5757] tracking-wider">SYSD_90</span>
